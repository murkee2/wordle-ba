...
const SOURCE_FALLBACKS = [null, 'https://raw.githubusercontent.com/LibreOffice/dictionaries/master/sr/sr.dic']
...
const CURATED_TARGET_WORDS = [
  ...
  'CEGER', 'CESTA', 'CIGLA', 'CIMET', 'CITAT', 'CRKVA', 'CRTEŽ', 'CVIJE', 'ČAMAC', 'ČASAK', 'ČASNA', 'ČEKIĆ', 'ČELIK', 'ČESMA', 'ČETKA', 'ČIPKA', 'ČISTO', 'ČIZMA', 'ČORBA', 'ČUDAN', 'ČUVAR', 'ČVRST',
  'ĆELAV', 'ĆEVAP', 'ĆILIM', 'ĆORAV', 'ĆOŠAK', 'DABAR', 'DALEK', 'DANAS', 'DASKA', 'DATUM', 'DEBEO', 'DEBLO', 'DEČKO', 'DEKOR', 'DESET', 'DINAR', 'DIOBA', 'DISKO', 'DIVAN', 'DLAKA', 'DOBAR', 'DOBRO', 'DOKAZ', 'DOKLE', 'DOLAP', 'DOMAR', 'DOMET', 'DRAMA', 'DRUGA', 'DRUGI', 'DRVEN', 'DUĆAN', 'DUGME', 'DUKAT', 'DUVAN', 'DUŽAN', 'ĐAČKI', 'ĐUBRE', 'ĐERĐE',
  'EFEKT', 'EKIPA', 'EKRAN', 'EKSER', 'ELITA', 'ETAPA', 'ETIKA', 'FAKIR', 'FARBA', 'FARMA', 'FAZAN', 'FIJUK', 'FIŠEK', 'FLOTA', 'FOKUS', 'FORMA', 'FORUM', 'FOTKA', 'FRAZA', 'FRULA', 'GAJBA', 'GALEB', 'GLAVA', 'GLINA', 'GLUMA', 'GORAK', 'GORKO', 'GOVOR', 'GOZBA', 'GRAĐA', 'GRANA', 'GRČKI', 'GROZA', 'GROZD', 'GRUDA', 'GRUDI', 'GRUPA', 'GUSAR', 'GUSKA', 'GUŽVA',
  'HABER', 'HAJDE', 'HAJKA', 'HAMAM', 'HARAM', 'HAREM', 'HARFA', 'HITAC', 'HITAN', 'HLJEB', 'HRANA', 'HRAST', 'HRBAT', 'HRVAT', 'HUMOR', 'IDIOT', 'IDILA', 'IGRAČ', 'IKONA', 'IMENA', 'IRVAS', 'ISKAZ', 'ISKOP', 'ISKRA', 'ISLAM', 'ISPAD', 'ISPIT', 'ISTOK', 'IZBOR', 'IZDAH', 'IZLAZ', 'IZLET', 'IZRAZ', 'IZROD', 'IZVOR',
  'JAHAT', 'JAKNA', 'JARAC', 'JARAK', 'JARAM', 'JARKO', 'JAVOR', 'JECAT', 'JEDAN', 'JEDRO', 'JELEN', 'JELKA', 'JESEN', 'JEZIK', 'JEZIV', 'JUČER', 'JUNAC', 'JUNAK', 'JURIŠ', 'JUTRO', 'KABAL', 'KADAR', 'KADET', 'KAJAK', 'KAKAO', 'KALUP', 'KAMEN', 'KANAP', 'KANON', 'KANTA', 'KAPAK', 'KAPAR', 'KARTA', 'KASNO', 'KATAR', 'KAUČI', 'KAZAN', 'KAZNA', 'KEČAP', 'KEFIR', 'KIKOT', 'KIPAR', 'KISEO', 'KISIK', 'KLADA', 'KLASA', 'KLIMA', 'KLUPA', 'KOCKA', 'KOFER', 'KOKOŠ', 'KOLAČ', 'KOLAC', 'KOLAR', 'KOLUT', 'KONAC', 'KONOP', 'KORAK', 'KORAL', 'KORPA', 'KORZO', 'KOSAC', 'KOSTI', 'KOTAO', 'KOVAČ', 'KRAVA', 'KREMA', 'KRILO', 'KRIVA', 'KRIZA', 'KROKI', 'KRUNA', 'KRUTA', 'KRVAV', 'KUČKA', 'KUHAR', 'KUPAC', 'KUPON', 'KUPUS', 'KVAKA', 'KVART',
  'LABUD', 'LADAN', 'LAHOR', 'LAJAT', 'LAKAT', 'LAKOM', 'LAMPA', 'LANAC', 'LASER', 'LATIN', 'LAŽOV', 'LAŽAN', 'LEDEN', 'LIMAR', 'LIMUN', 'LISAC', 'LISKA', 'LISTA', 'LITRA', 'LOGOR', 'LOKAL', 'LOKOT', 'LOPTA', 'LOVAC', 'LOVOR', 'LUKAV', 'MAGLA', 'MAJKA', 'MAMAC', 'MAMUT', 'MANIR', 'MARKA', 'MASER', 'MASKA', 'MASLO', 'MAŠTA', 'MATER', 'MAČKA', 'MAČOR', 'MEDAL', 'MEDEN', 'MEDAR', 'MELEK', 'MELOS', 'MENZA', 'MERAK', 'MESAR', 'MESNI', 'METAL', 'METAR', 'METLA', 'METRO', 'MEZAR', 'MINER', 'MINUT', 'MIRAZ', 'MIRAN', 'MIRNO', 'MIRIS', 'MISLI', 'MJERA', 'MJEST', 'MLADA', 'MLADI', 'MLADO', 'MODAR', 'MODEL', 'MOKAR', 'MOKRA', 'MOLBA', 'MOLER', 'MOMAK', 'MORAL', 'MORAT', 'MOTEL', 'MOTOR', 'MOTKA', 'MOZAK', 'MRAVI', 'MREŽA', 'MRKVA', 'MRTAV', 'MRTVI', 'MUDAR', 'MUDRO', 'MURAL', 'MUŠKA', 'MUZEJ',
  'NACRT', 'NAFTA', 'NAGAO', 'NAGLO', 'NALOG', 'NAMET', 'NAPAD', 'NAPON', 'NAPOR', 'NARAV', 'NAROD', 'NASIP', 'NAUKA', 'NAVAL', 'NAVOZ', 'NAZAD', 'NAZIV', 'NAZOR', 'NEĆAK', 'NEHAJ', 'NEMAR', 'NEMIR', 'NERAD', 'NERED', 'NETKO', 'NIŠAN', 'NOĆAS', 'NOGAR', 'NOKAT', 'NOSAČ', 'NOSAT', 'NOTAR', 'NOVAC', 'NOŽIĆ', 'OBALA', 'OBLAK', 'OBLIK', 'OBRAZ', 'OBRED', 'OBRIS', 'OBRVA', 'OBUĆA', 'OBUKA', 'OČITO', 'ODBOJ', 'ODBOR', 'ODLAZ', 'ODLIK', 'ODLIV', 'ODLUK', 'ODMAH', 'ODMET', 'ODMOR', 'ODNOS', 'ODPAD', 'ODRAZ', 'ODRED', 'ODRON', 'ODVEĆ', 'ODVOD', 'ODVOZ', 'OGLAS', 'OGLED', 'OGREV', 'OKLOP', 'OKOLO', 'OKRET', 'OKRUG', 'OKRUT', 'OKUKA', 'OKUSI', 'OKVIR', 'OLOVO', 'OLTAR', 'OLUJA', 'OMLET', 'ONAMO', 'OPADA', 'OPAKA', 'OPEKA', 'OPERA', 'OPHOD', 'OPREZ', 'OPSEG', 'OPTIK', 'ORGAN', 'ORMAR', 'ORTAK', 'OSAMA', 'OSEKA', 'OSNOV', 'OSOBA', 'OSTRV', 'OSUDA', 'OSVRT', 'OŠTAR', 'OŠTRI', 'OŠTRO', 'OTKAZ', 'OTKOS', 'OTKUP', 'OTOKA', 'OTROV', 'OTVOR', 'OVAMO', 'OVČAR',
  ...
  'ŠABAN', 'ŠAHOV', 'ŠAJKA', 'ŠAMAC', 'ŠAMAN', 'ŠAMAR', 'ŠANSA', 'ŠAPAT', 'ŠARAC', 'ŠARAF', 'ŠARAN', 'ŠAREN', 'ŠARKA', 'ŠATOR', 'ŠATRA', 'ŠEĆER', 'ŠEHID', 'ŠEKER', 'ŠEPAV', 'ŠERET', 'ŠERIF', 'ŠERPA', 'ŠESTI', 'ŠESTO', 'ŠEŠIR', 'ŠETAT', 'ŠIBAK', 'ŠIBAT', 'ŠIBIC', 'ŠIPAK', 'ŠIPKA', 'ŠIROK', 'ŠIŠAR', 'ŠIŠAT', 'ŠIŠKE', 'ŠIVAC', 'ŠIVAT', 'ŠKAMP', 'ŠKARE', 'ŠKART', 'ŠKODA', 'ŠKOLA', 'ŠKOTA', 'ŠKRIP', 'ŠKROB', 'ŠKRTI', 'ŠKRTO', 'ŠKUDA', 'ŠKURA', 'ŠMINK', 'ŠPAGA', 'ŠPAJZ', 'ŠPION', 'ŠPRIC', 'ŠTAKA', 'ŠTAMP', 'ŠTAND', 'ŠTAPA', 'ŠTAPI', 'ŠTEDI', 'ŠTEKA', 'ŠTETA', 'ŠTIMA', 'ŠTIPA', 'ŠTITO', 'ŠTOFA', 'ŠTORE', 'ŠTRAJ', 'ŠTRIK', 'ŠTUCA', 'ŠTUKA', 'ŠTURA', 'ŠTURI', 'ŠUBAR', 'ŠUĆUR', 'ŠUGAV', 'ŠUMAR', 'ŠUMOR', 'ŠUNKA', 'ŠUPAK', 'ŠUŠAK', 'ŠUŠKA', 'ŠUŠTA', 'ŠUŠTI', 'ŠUTIO', 'ŠUTIT', 'ŠUTKE', 'ŠVERC',
...
function parseDictionary(text) {
  return text
    .split(/\r?\n/u)
    .slice(1)
    .map(line => line.trim().split(/\s+/u)[0].split('/')[0].toUpperCase())
    .filter(word => WORD_PATTERN.test(word) && !FORBIDDEN_DIGRAPHS.test(word))
}
...
const dictionaryTexts = await Promise.all([
  downloadDictionary(SOURCE_URLS[0]),
  downloadDictionary(SOURCE_URLS[1], SOURCE_FALLBACKS[1]),
])
...
if (validWords.length < 10000) {
  console.warn('Warning: available sources produced fewer than 10,000 strict five-letter words; no synthetic words were added.')
}
